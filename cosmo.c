...
// copy Frank's program 
{
	...
	// this set provides better fit to the genmfcode result in the range 7<logM/(Msun/h)<17
	a2=1.200;
	a3=-1.888;
	a4=1.172;
	a5=-0.2378;

	// this set provides better fit to the Bolshoi result (computed using genfcode based on the Bolshoi P(k)) in the range 7<logM/(Msun/h)<17
	a2 = 1.205;
	a3=-1.888;
    a4=1.172;
    a5=-0.2378;
